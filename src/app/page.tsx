...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col relative overflow-x-hidden font-sans select-none">
      {/* Background Decor Gradients */}
      <div className="absolute top-[-300px] left-[-200px] w-[600px] h-[600px] rounded-full bg-emerald-100/40 blur-3xl pointer-events-none z-0" />
      <div className="absolute top-[20%] right-[-150px] w-[500px] h-[500px] rounded-full bg-teal-50/50 blur-3xl pointer-events-none z-0" />
      <div className="absolute bottom-[-100px] left-[10%] w-[700px] h-[700px] rounded-full bg-slate-100 blur-3xl pointer-events-none z-0" />
      ...
      <header className="w-full max-w-7xl mx-auto px-6 h-20 flex items-center justify-between z-10 relative">
        ...
        <div className="flex items-center gap-6">
          <span className="hidden md:inline text-xs text-slate-400 font-semibold tracking-wider uppercase">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center py-8 lg:py-16 z-10 relative">
        ...
        >
          ...
          <motion.p 
            variants={fadeInUp}
            className="text-slate-500 text-base sm:text-lg max-w-2xl mx-auto lg:mx-0 leading-relaxed"
          >
        ...
        >
          <div className="bg-white/80 backdrop-blur-md rounded-2xl border border-slate-100 shadow-xl p-8 relative overflow-hidden group">
            {/* Glowing card dot */}
            ...
            <div className="space-y-6">
              <div className="space-y-1.5 text-center">
                <h3 className="text-xl font-bold text-slate-900">Bắt đầu ngay lập tức</h3>
                <p className="text-xs text-slate-400">Chỉ mất 10 giây để tạo phòng chia tiền</p>
              </div>
              ...
              <form onSubmit={handleCreateGroup} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="h-12 border-slate-200 focus-visible:ring-emerald-500/20 focus-visible:border-emerald-500 rounded-xl text-slate-800 text-sm shadow-sm transition-all bg-white"
                    required
                    autoFocus
                  />
                </div>
      ...
      <section className="bg-white border-t border-slate-100 py-16 lg:py-24 z-10 relative mt-16">
        <div className="max-w-7xl mx-auto px-6 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Feature 1 */}
            <div className="p-6 bg-slate-50 rounded-xl border border-slate-100/50 hover:border-emerald-200/50 hover:bg-white hover:shadow-md transition-all space-y-4">
              <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-emerald-50 text-emerald-600">
                <Zap size={20} />
              </div>
              <h4 className="font-bold text-slate-800 text-base">Khởi tạo tức thì</h4>
            ...
            <div className="p-6 bg-slate-50 rounded-xl border border-slate-100/50 hover:border-emerald-200/50 hover:bg-white hover:shadow-md transition-all space-y-4">
              ...
              <h4 className="font-bold text-slate-800 text-base">Tối giản hóa nợ chéo</h4>
              <p className="text-xs text-slate-500 leading-relaxed">
            ...
            <div className="p-6 bg-slate-50 rounded-xl border border-slate-100/50 hover:border-emerald-200/50 hover:bg-white hover:shadow-md transition-all space-y-4">
              ...
              <h4 className="font-bold text-slate-800 text-base">Chia sẻ đồng bộ nhanh</h4>
              <p className="text-xs text-slate-500 leading-relaxed">
            ...
            <div className="p-6 bg-slate-50 rounded-xl border border-slate-100/50 hover:border-emerald-200/50 hover:bg-white hover:shadow-md transition-all space-y-4">
              ...
              <h4 className="font-bold text-slate-800 text-base">VietQR Bảo mật & Tiện lợi</h4>
              <p className="text-xs text-slate-500 leading-relaxed">
      ...
      {/* 4. Footer */}
      <footer className="w-full bg-slate-900 text-slate-400 py-12 border-t border-slate-800 mt-auto z-10 relative">
